...
export default function Home() {
  return (
    <section className="max-w-xl">
      <img src="/profile-picture.png" className="w-16 h-16 mb-4" />
      <h1 className="text-4xl font-bold">Professional Software Engineer and Gamers.</h1>
      <p className="mt-3 text-gray-500">{"I’m Toufiq, a professional software based on Jakarta. I'm also a professional e-sport gamers."}</p>
      <div className="flex justify-between items-center gap-5 mt-3 w-[192px]">
        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-7 w-7 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
      ...
      <div className="mt-2 flex justify-between items-center gap-5">
        <div className="relative aspect-[9/10] w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800 -rotate-2">
          <img className="absolute inset-0 h-full w-full object-cover" src="https://source.unsplash.com/macbook-pro-on-table-beside-white-imac-and-magic-mouse-hGV2TfOh0ns" />
        </div>
        <div className="relative aspect-[9/10] w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800 rotate-2">
          <img className="absolute inset-0 h-full w-full object-cover" src="https://source.unsplash.com/person-using-desktop-computer-WcrqKjgMPfI" />
        </div>
      </div>
    </section>
  );
